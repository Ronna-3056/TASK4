...
namespace CalculatorApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // The while loop allows the program to repeat until 'N' is pressed
            while (char.ToUpper(continueChoice) == 'Y')
            {
                ...
                // Switch-case structure to route the program execution
                switch (choice)
                {
                    case "1":
                    ...
                    case "3":
                        ...
                        break;
                    case "4":
                        // Logic check to prevent division by zero
                        if (val2 != 0)
        ...
        // Dedicated methods for each arithmetic operation
